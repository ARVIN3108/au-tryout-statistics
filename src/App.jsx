...
export default function App() {
  ...
  useEffect(() => {
    ...
    const isOld = params.get("old") === "true";
    ...
    if (isOld) {
      ...
      setAuthorized(true);
    } else window.location.replace("https://hasiltryoutakbar.vercel.app");
  }, []);
                ...
                <Menu>
                  ...
                  >
                    ...
                    {selectedJSON.types[selectedType]?.toLowerCase() == "real"
                      ...
                      : selectedJSON.types[selectedType]?.toLowerCase() ==
                          "toafl"
                        ? selectedJSON.types[selectedType]?.toUpperCase() +
                          " / KHOS"
                        : selectedJSON.types[selectedType]?.toUpperCase()}
