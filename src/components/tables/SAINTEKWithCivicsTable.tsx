...
export default function SAINTEKWithCivicsTable({ data }: { data: Row[] }) {
  return (
    <table className="w-full text-center text-sm text-gray-500 opacity-90 rtl:text-right dark:text-gray-400">
      <thead className="border-b-2 bg-gray-50 text-xs whitespace-nowrap text-gray-700 uppercase dark:bg-gray-700 dark:text-gray-300">
        <tr>
          ...
          <th scope="col" className="p-3">
            <span className="absolute -mt-0.5 -ml-3">MAT WAJIB</span>
            <br />
            BNR
          </th>
          <th scope="col" className="p-3">
          ...
          <th scope="col" className="p-3">
            <span className="absolute -mt-0.5 -ml-3">MAT MINAT</span>
            <br />
            BNR
          </th>
          <th scope="col" className="p-3">
          ...
          <th scope="col" className="p-3">
            <span className="absolute -mt-0.5 ml-1">FISIKA</span>
            <br />
            BNR
          </th>
          <th scope="col" className="p-3">
          ...
          <th scope="col" className="p-3">
            <span className="absolute -mt-0.5 ml-1">KIMIA</span>
            <br />
            BNR
          </th>
          <th scope="col" className="p-3">
          ...
          <th scope="col" className="p-3">
            <span className="absolute -mt-0.5 ml-2.5">PKN</span>
            <br />
            BNR
          </th>
          <th scope="col" className="p-3">
          ...
          data.map((row, rowIndex) => (
            ...
            >
              ...
              {row.map((cell, cellIndex) => {
                if (cellIndex == 1 || cellIndex == 21)
                  return (
                    <td
                      key={cellIndex}
                      className={`px-6 py-4 ${cellIndex == 21 && `text-gray-900 dark:text-white ${rowIndex == data.length - 1 && "rounded-br-lg"}`}`}
                    >
                      {cell as string}
                    </td>
                  );
